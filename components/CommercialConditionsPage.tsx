...
const ToolCard: React.FC<{ title: string; description: string; children: React.ReactNode; icon: React.ReactNode; }> = ({ title, description, children, icon }) => (
        ...
        <div className="animate-fade-in h-full p-4 md:p-8 overflow-y-auto">
            ...
            <div className="flex flex-col gap-6">
                ...
                >
                    ...
                    <a
                        href="https://www.dropbox.com/scl/fi/xvdkpbalo935tpp408l04/PROMO-ALTA-NUEVA-CLIENTE.pdf?rlkey=dwea27hbgeymhosc7t0ezxipt&st=t80m2l7r&dl=0"
                        target="_blank"
                ...
                >
                    <p className="font-semibold text-xs">Coste neto: 300€. Incluye expositor de platos + 2 platos de 160x70cm (acabado a elegir). ¡Una herramienta de venta clave para aumentar la visibilidad del producto en tienda!</p>
                    <a
                        href="https://www.dropbox.com/scl/fi/vvso5uq0cuaxq8t6602gy/PROMO-EXPO-PLATOS-AQG-2025.pdf?rlkey=4tb6hz1m0zbbkzfc51ezrps1b&st=g1bfcmta&dl=0"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-block w-full px-4 py-2 text-sm font-semibold text-white bg-teal-600 rounded-md hover:bg-teal-700 transition-colors"
                    >
                ...
                >
                    <p className="font-semibold text-xs">Argumento de venta: El cliente compra producto para su exposición y se le aplicará un 10% de descuento en todos sus pedidos hasta cubrir el coste del producto de exposición.</p>
                </ToolCard>
                ...
                >
                    <p className="font-semibold text-xs">Pedido mínimo 20/25 uds. de la colección CLASSIC (colores y medidas estándar combinables). Forma de pago: 3 meses de carencia inicial. Tras la carencia, el pago se fracciona en 3 ó 6 cuotas mensuales hasta liquidar el total. Condiciones sujetas a recurrencia de pedidos.</p>
                </ToolCard>
            </div>
        </div>
    );
